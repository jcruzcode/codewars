...
1) Parameters - Four numbers: principal, interest, tax, desired.
2) Return - The number of years the principal has to be compounded before reaching the desired amount.
3) Examples - see test
...
// Keep compounding interest, minus tax, until the sum reaches the desired amount
  while (sum < desired) {
    sum *= 1 + interest * (1 - tax);
    yearCount++; // Keep track of years compounded
  }
// Return the number of years it will take to reach desired amount
  return yearCount;
}
