...
return the result of the corresponding mathematical function 
on the two numbers. 
...
1) Parameters - Two numbers, num1 & num2, and a string, operation.
2) Return - The result of the math operation specified by operation on num1 and num2.
            Return null if dividing by zero or for non-valid operator.
...
function calculate(num1, operation, num2) {
  return operation === "+"
    ...
    : operation === "/" && num2 === 0
    ? null // divide by zero returns null
    : operation === "/"
    ? num1 / num2 // division
    : null; // Return null for invalid operator
}
