...
1) Parameters - Strings name and password.
2) Return - True if name is "Santa Claus" and password is "Ho Ho Ho!", otherwise
            false.
...
Sleigh.prototype.authenticate = function (name, password) {
  // Check that name equals "Santa Claus" and the password is "Ho Ho Ho!"
