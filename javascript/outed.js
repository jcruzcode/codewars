...
need to assess the overall happiness rating of the group. 
...
1) Parameter - An object, meet, and a string, boss.
2) Return - An string based on the happiness rating calculated.
...
function outed(meet, boss) {
  ...
  for (let person in meet) {
    person === boss ? (score += 2 * meet[person]) : (score += meet[person]);
  }
  // Compare happiness rating to threshold
