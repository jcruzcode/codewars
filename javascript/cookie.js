...
1) Parameter - A string, number, or other data type.
2) Return - A message specifiying 'Zach' if x is a string, 'Monica' if x is a 
            number, and "the dog" if another data type.
3) Examples - see tests
4) Pseudocode - see comments

*/
function cookie(x) {
  // Return message based on data type
