...
1) Parameters - A nested array of numbers, representing stairs climbed for each day of the week of an entire year.
2) Return - An estimate of how many stairs will be climbed in 20 years as a number.
3) Examples - see tests
4) Pseudocode - see comments

*/
function stairsIn20(s) {
  // Sum all daily values of stairs climbed for the year 
  // and multiply by 20 to estimate the 20 year total
  return s.flat(2).reduce((sum, val) => sum + val, 0) * 20;
}
// Tests
let sunday = [
