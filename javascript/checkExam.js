...
function checkExam(array1, array2) {
    ...
    for (let i = 0; i < array1.length; i++) {
        // Calculate score based on the student's answers 
      array1[i] === array2[i] ? score += 4 : array1[i] !== array2[i] && array2[i] !== "" ? score -= 1 : score = score;
    }
    // Ensure score returned is non-negative
